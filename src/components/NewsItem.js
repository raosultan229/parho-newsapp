...
const NewsItem = (props)=>{
    ...
    return (
      ...
      <img src={!imageUrl?"https://www.investors.com/wp-content/uploads/2017/04/tesla-assemblyline-finishedcars-tsla-company-1.jpg":imageUrl} className="card-img-top" alt="..."/>
